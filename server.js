...
注：
 - 代码内容要仔细核对到底是哪个语言的代码，尤其不要错误地把苹果Swift语言的代码识别成其他语言！！！
 - 只有跟计算机软件相关的内容才有可能判定为技术文本，否则判定为其他内容。其他内容可能有：数学、物理、化学、计算机、生物、医学、科技、计算机硬件、金融、时政、新闻，或者其他各种学习型内容。
 - 只有内容确实是技术文本才会判定7为技术文本，如果是其他跟计算机相关的但不是文本内容则不要判断为技术文本，例如文件发了一个系统设置，文件结构图片等等，这些都不是技术文本。注意，用户可能发送图片，图片也可以被判断为技术文本，只要图片里的内容确实是技术文本。
